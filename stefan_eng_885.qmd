...
\text{logit}(\mu_i) &= \beta_0 + \beta_1 \cdot \text{surgery}_i + \beta_2 \cdot \text{transplant}_i + \beta_3 \cdot \text{age}_i + \beta_4 \cdot (\text{surgery}_i \cdot \text{transplant}_i) \nonumber \\
    &\quad\quad +  \beta_5 \cdot (\text{surgery}_i \cdot \text{age}_i) + \beta_6 \cdot (\text{transplant}_i \cdot \text{age}_i) + \beta_7 \cdot (\text{surgery}_i \cdot \text{transplant}_i \cdot \text{age}_i) \label{eq:logit1}\\
\text{logit}(\mu_i) &= \beta_0 + \beta_1 \cdot \text{surgery}_i + \beta_2 \cdot \text{transplant}_i + \theta_{\text{surgery}}(\text{age}_i)\cdot \text{surgery}_i \label{eq:logit2}\\
\text{logit}(\mu_i) &= \beta_0 + \beta_1 \cdot \text{surgery}_i + \beta_2 \cdot \text{transplant}_i + \theta_{\text{transplant}}(\text{age}_i)\cdot \text{transplant}_i \label{eq:logit3} \\
\text{logit}(\mu_i) &= \beta_0 + \beta_1 \cdot \text{surgery}_i + \beta_2 \cdot \text{transplant}_i\\
&\quad\quad +\theta_{\text{surgery}}(\text{age}_i)\cdot \text{surgery}_i + \theta_{\text{transplant}}(\text{age}_i) \cdot \text{transplant}_i \label{eq:logit4}
\end{align}
